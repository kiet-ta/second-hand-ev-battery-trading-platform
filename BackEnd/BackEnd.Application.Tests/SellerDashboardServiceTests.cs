...
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(It.IsAny<int>(), OrderItemStatus.Pending.ToString())).ReturnsAsync(4);
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(It.IsAny<int>(), OrderItemStatus.Paid.ToString())).ReturnsAsync(3);
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(It.IsAny<int>(), OrderItemStatus.Completed.ToString())).ReturnsAsync(10);
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(It.IsAny<int>(), OrderItemStatus.Shipped.ToString())).ReturnsAsync(1);
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(It.IsAny<int>(), OrderItemStatus.Cancelled.ToString())).ReturnsAsync(2);
...
//            // Arrange
//            SetupSuccessMocks();
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(SellerId, OrderItemStatus.Pending.ToString())).ReturnsAsync(14);
...
//            // Arrange
//            SetupSuccessMocks();
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(SellerId, OrderItemStatus.Paid.ToString())).ReturnsAsync(25);
...
//            // Arrange
//            SetupSuccessMocks();
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(SellerId, OrderItemStatus.Completed.ToString())).ReturnsAsync(50);
...
//            // Arrange
//            SetupSuccessMocks();
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(SellerId, OrderItemStatus.Shipped.ToString())).ReturnsAsync(3);
...
//            // Arrange
//            SetupSuccessMocks();
//            _mockOrderRepo.Setup(r => r.CountByStatusAsync(SellerId, OrderItemStatus.Cancelled.ToString())).ReturnsAsync(0);
