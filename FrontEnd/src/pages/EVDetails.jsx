...
function EVDetails() {
  ...
  return (
    <div className="">
      <div className="grid grid-cols-4 gap-4 mt-2 w-full h-screen">
        ...
        <div className="product bg-white rounded-2xl p-4 flex justify-center">
          ...
          /></div>
      <div className="more-info grid gird-flow-col grid-rows-4 gap-10 grid-cols-2 bg-white mt-5 h-4/10 rounded-2xl p-4 m-4">
        <div>1wqeewqewqewq</div>
        <div>2</div>
        <div>3qweqwe</div>
        <div>4</div>
        <div>5</div>
      ...
      <div className="col-span-2">
        <div className="product-info bg-white rounded-2xl p-4 h-2/3">
          <div className="title h-2/8 text-3xl  text-left content-center flex-none font-semibold text-black overflow-hidden whitespace-pre-wrap" style={{ display: 'block', wordBreak: 'break-word' }}>
        ...
        <div className="price-tag flex h-1/10 text-left mt-2">
        ...
        <div className="phone-number flex gap-4 h-2/10 mt-4">
        ...
        <div className="comment bg-white rounded-2xl p-4 h-1/3 mt-5"></div>
      </div>
      </div>
    </div>
  )
